...
class ValidatorTest extends TestCase
{
    ...
    {
        $data = [
            "username" => "marcell@arcom.com",
            "password" => "marcell@arcom.com"
        ];
    ...
    public function testValidatorRuleClasses()
    {
        $data = [
            "username" => "Marcell",
            "password" => "marcell@arcom123.com"
        ];

        $rules = [
            "username" => ["required", new In(["Marcell", "Suyud", "Natura"])],
